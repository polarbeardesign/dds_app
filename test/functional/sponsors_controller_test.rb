...
class SponsorsControllerTest < ActionController::TestCase
  ...
  test "should create sponsor" do
    assert_difference('Sponsor.count') do
      post :create, sponsor: { logo: @sponsor.logo, notes: @sponsor.notes, sponsor_name: @sponsor.sponsor_name, url: @sponsor.url }
    end
  ...
  test "should update sponsor" do
    put :update, id: @sponsor, sponsor: { logo: @sponsor.logo, notes: @sponsor.notes, sponsor_name: @sponsor.sponsor_name, url: @sponsor.url }
    assert_redirected_to sponsor_path(assigns(:sponsor))
  end
