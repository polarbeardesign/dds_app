...
skip_before_filter :check_authorization, :check_authentication, :only => [:home, :VMB612, :PBJs, :squadron, :map_0, :map_2013, :living_flight_history_experience, :refund_policy, :thank_you, :operations_2014, :fb_test, :arsenal_of_democracy, :supportcaf]
...
# page views are hard coded in view files
  ...
  def member_home
   ...
   @quick_links = Content.find_by_id(8)
