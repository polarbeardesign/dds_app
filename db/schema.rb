...
ActiveRecord::Schema.define(:version => 20171102143447) do
  ...
  create_table "dues_reminders", :force => true do |t|
    t.integer  "member_id"
  ...
  add_index "dues_reminders", ["member_id"], :name => "index_dues_reminders_on_member_id"
